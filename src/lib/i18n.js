...
const translations = {
  en: {
    ...
    quantityLabel: "Quantity (e.g., kg, units)",
    ...
    fillPurchaseDetails: "Please fill in all purchase details correctly (Quantity > 0, Price >= 0).",
  ...
  te: {
    ...
    quantityLabel: "పరిమాణం (ఉదా., కిలోలు, యూనిట్లు)",
    ...
    fillPurchaseDetails: "దయచేసి అన్ని కొనుగోలు వివరాలను సరిగ్గా పూరించండి (పరిమాణం > 0, ధర >= 0).",
